...
template<class OP>
__device__ inline typename OP::RedElTp
scanIncBlock(volatile typename OP::RedElTp* ptr, const unsigned int idx) { // idx - 1023  = 1111111111
    const unsigned int lane   = idx & (WARP-1); // idx & 11111 -> lane = 11111 = 31 
    const unsigned int warpid = idx >> lgWARP; // 1111111111 >> 5 = 11111 (idx = 1023) = 31
